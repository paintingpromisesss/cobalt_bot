...
func NewSender(log *zap.Logger, ffprobeTimeout time.Duration, ffmpegTimeout time.Duration) *Sender {
	return &Sender{
		log:            log,
...
func (s *Sender) buildMedia(filePath, fileName, detectedMIME string) (any, func()) {
